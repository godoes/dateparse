...
Parse many date strings without knowing format in advance. Uses a scanner to read bytes and use a state machine to find
format. Much faster than shotgun based parse methods.
See [bench_test.go](https://github.com/godoes/dateparse/blob/master/bench_test.go) for performance comparison.

[![Code Coverage](https://codecov.io/gh/godoes/dateparse/branch/master/graph/badge.svg)](https://codecov.io/gh/godoes/dateparse)
[![GoDoc](https://godoc.org/github.com/godoes/dateparse?status.svg)](http://godoc.org/github.com/godoes/dateparse)
[![Build Status](https://travis-ci.org/godoes/dateparse.svg?branch=master)](https://travis-ci.org/godoes/dateparse)
[![Go ReportCard](https://goreportcard.com/badge/godoes/dateparse)](https://goreportcard.com/report/godoes/dateparse)

**MM/DD/YYYY VS DD/MM/YYYY** Right now this uses mm/dd/yyyy WHEN ambiguous if this is not desired behavior,
use `ParseStrict` which will fail on ambiguous date strings.

**Timezones** The location your server is configured affects the results!  See example
or <https://play.golang.org/p/IDHRalIyXh> and last paragraph here <https://golang.org/pkg/time/#Parse>.
...
[Date Parse CLI](https://github.com/godoes/dateparse/blob/master/dateparse)

## Extended example

<https://github.com/godoes/dateparse/blob/master/example/main.go>
